 ...
 <div class="row">
  ...
  <div class="col-md-2">
    <a href="art_inside.php" class="thumbnail">
        <p>Dali</p>
        <img src="Kunst/Schilder/schilderDali.png" alt="schilderDali" style="width:50px;height:50px">
        <br>
    </a>
  ...
  <div class="col-md-2">
    <a href="Kunst/Schilder/dali1.png" class="thumbnail">
      <p>dali1</p>
      <img src="Kunst/Schilder/dali1.png" alt="dali1" style="width:50px;height:50px">
      <br>
    </a>
  </div>
